...
public class BOOK_was_published_by_PUBLISHER extends Lesson {
    public static final String KEY = "BOOK_was_published_by_PUBLISHER";
    //placeholders
    ...
    public BOOK_was_published_by_PUBLISHER(WikiBaseEndpointConnector connector, LessonData data){
