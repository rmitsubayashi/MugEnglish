...
public class CITY_is_in_TERRITORY extends Lesson {
    public static final String KEY = "CITY_is_in_TERRITORY";
    //placeholders
    ...
    public CITY_is_in_TERRITORY(WikiBaseEndpointConnector connector, LessonData data){
