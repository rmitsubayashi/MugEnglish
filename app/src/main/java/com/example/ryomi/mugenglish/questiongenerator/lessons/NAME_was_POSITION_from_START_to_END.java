...
public class NAME_was_POSITION_from_START_to_END extends Lesson {
    public static final String KEY = "NAME_was_POSITION_from_START_to_END";
    //クエリーするときの名前
    ...
    public NAME_was_POSITION_from_START_to_END(WikiBaseEndpointConnector connector, LessonData data){
