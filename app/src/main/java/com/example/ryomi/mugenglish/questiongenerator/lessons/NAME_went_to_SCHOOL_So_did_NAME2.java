...
public class NAME_went_to_SCHOOL_So_did_NAME2 extends Lesson {
	public static final String KEY = "NAME_went_to_SCHOOL_So_did_NAME2";
	...
	public NAME_went_to_SCHOOL_So_did_NAME2(WikiBaseEndpointConnector connector, LessonData data){
