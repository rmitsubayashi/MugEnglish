...
import com.example.ryomi.mugenglish.gui.LessonDetails;
...
public class LessonListAdapter
        extends FirebaseRecyclerAdapter<LessonData, LessonListViewHolder> {

    private ProgressBar loading;

    public LessonListAdapter(Query query, ProgressBar loading){
        super(LessonData.class, R.layout.inflatable_lesson_list_list_item,
                LessonListViewHolder.class, query);
        this.loading = loading;
    }

    @Override
    public void populateViewHolder(LessonListViewHolder holder, LessonData data, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                LessonData data = LessonListAdapter.this.getItem(fPosition);
                int colorPos = fPosition % (blueShades.length);
                int color = blueShades[colorPos];
                Intent intent = new Intent(fContext, LessonDetails.class);
                intent.putExtra("lessonData",data);
