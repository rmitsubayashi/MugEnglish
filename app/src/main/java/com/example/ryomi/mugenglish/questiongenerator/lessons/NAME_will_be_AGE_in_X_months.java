...
public class NAME_will_be_AGE_in_X_months extends Lesson {
    public static final String KEY = "NAME_will_be_AGE_in_X_months";
    //placeholders
    ...
    public NAME_will_be_AGE_in_X_months(WikiBaseEndpointConnector connector, LessonData data) {
