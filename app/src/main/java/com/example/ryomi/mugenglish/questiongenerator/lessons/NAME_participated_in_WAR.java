...
public class NAME_participated_in_WAR extends Lesson {
    public static final String KEY = "NAME_participated_in_WAR";
    //placeholders
    ...
    public NAME_participated_in_WAR(WikiBaseEndpointConnector connector, LessonData data){
