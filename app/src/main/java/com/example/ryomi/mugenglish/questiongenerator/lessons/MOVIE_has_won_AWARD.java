...
public class MOVIE_has_won_AWARD extends Lesson {
    public static final String KEY = "MOVIE_has_won_AWARD";
    //placeholders
    ...
    public MOVIE_has_won_AWARD(WikiBaseEndpointConnector connector, LessonData data){
