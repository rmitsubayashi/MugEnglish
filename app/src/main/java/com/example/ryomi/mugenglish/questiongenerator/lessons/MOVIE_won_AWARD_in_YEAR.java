...
public class MOVIE_won_AWARD_in_YEAR extends Lesson {
    public static final String KEY = "MOVIE_won_AWARD_in_YEAR";
    //クエリーするときの名前
    ...
    public MOVIE_won_AWARD_in_YEAR(WikiBaseEndpointConnector connector, LessonData data){
