...
public class The_JIS_area_code_of_PLACE_is_NUMBER extends Lesson {
    public static final String KEY = "The_JIS_area_code_of_PLACE_is_NUMBER";
    //placeholders
    ...
    public The_JIS_area_code_of_PLACE_is_NUMBER(WikiBaseEndpointConnector connector, LessonData data){
