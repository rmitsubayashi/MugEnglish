...
public class NAME_plays_SPORT extends Lesson {
	...
	public static final String TITLE = "|名前|は|スポーツ|をしています";
	...
	public NAME_plays_SPORT(WikiBaseEndpointConnector connector, LessonData data){
	...
	protected void accessDBWhenCreatingQuestions(){
		...
		ref.addListenerForSingleValueEvent(new ValueEventListener() {
			...
			public void onDataChange(DataSnapshot dataSnapshot) {
				...
				NAME_plays_SPORT.super.saveNewQuestions();
			}
