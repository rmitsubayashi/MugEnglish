...
public class ThemeList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final List<ThemeCellData> testData = new ArrayList<>();
        final List<ThemeData> themeData = new ArrayList<>();
        final List<Boolean> testStars = new ArrayList<>();
        testStars.add(true);
        testStars.add(false);
        testStars.add(true);
        ...
        firebaseAdapter = new FirebaseListAdapter<ThemeData>(
            ...
            protected void populateView(View v, ThemeData data, int position) {
                ...
                GUIUtils.populateStars(starList, testStars);
        ...
        /*
        ThemeData data = new ThemeData("id","education","title","category","description");
        for (int i=0; i<9; i++){
            testData.add(new ThemeCellData(data,blueShades[i%4],testStars));
        }
        gridview.setAdapter(new ThemeGridAdapter(this, testData));*/
