...
public class LessonListViewerImplementation extends LessonListViewer{
    ...
    protected void populateLessons(){
        ...
        col3Data = new LessonData(NAME_is_AGE_years_old.KEY, people, R.layout.description_name_is_age_years_old, col3Prerequisites, 100, R.attr.color700, peopleIconID);
        ...
        col2Data = new LessonData(Numbers_0_3.KEY, numbers, R.layout.description_numbers_0_3, null, 100, R.attr.color500, numbersIconID);
        col3Prerequisites = new ArrayList<>(1);
        col3Prerequisites.add(NAME_is_AGE_years_old.KEY);
        col3Data = new LessonData(NAME_is_AGE_years_old_NAME_is_a_GENDER.KEY, people, R.layout.description_name_is_age_years_old_name_is_a_gender, col3Prerequisites, 100, R.attr.color700, peopleIconID);
        row.setCol1(col1Data);
        row.setCol2(col2Data);
        row.setCol3(col3Data);
        lessonRows.add(row);
        ...
        col2Data = new LessonData(Numbers_4_6.KEY, numbers, R.layout.description_numbers_4_6, col2Prerequisites, 100, R.attr.color500, numbersIconID);
        row.setCol1(col1Data);
        row.setCol2(col2Data);
        row.setCol3(null);
        lessonRows.add(row);
        ...
        col2Data = new LessonData(Numbers_7_9.KEY, numbers, R.layout.description_numbers_7_9, col2Prerequisites, 100, R.attr.color500, numbersIconID);
        row.setCol1(null);
        row.setCol2(col2Data);
        row.setCol3(null);
        lessonRows.add(row);
        ...
        col3Data = new LessonData(COMPANY_makes_PRODUCT.KEY, occupations, R.layout.description_company_makes_product, col3Prerequisites, 100, R.attr.color500, placesIconID);
        row.setCol1(col1Data);
        row.setCol2(col2Data);
        row.setCol3(col3Data);
        lessonRows.add(row);
        ...
        col2Data = new LessonData(Numbers_10s.KEY, numbers, R.layout.description_numbers_10s, null, 100, R.attr.color300, numbersIconID);
        col3Prerequisites = new ArrayList<>(1);
        ...
        col2Data = new LessonData(Numbers_11_19.KEY, numbers, R.layout.description_numbers_11_19, col2Prerequisites, 100, R.attr.color300, numbersIconID);
        col3Prerequisites = new ArrayList<>(1);
        ...
        col3Data = new LessonData(NAME_is_young_He_is_AGE.KEY, people, R.layout.description_name_is_young_he_is_age, col3Prerequisites, 100, R.attr.color700, peopleIconID);
        row.setCol2(col2Data);
        row.setCol3(col3Data);
        lessonRows.add(row);
        ...
        row = new LessonListRow();
        col1Data = new LessonData(NAME_writes_books.KEY, occupations, R.layout.description_name_writes_books, null, 100, R.attr.color300, peopleIconID);
        col2Data = new LessonData(NAME_plays_SPORT_It_is_a_water_sport.KEY, occupations, R.layout.description_name_plays_sport_it_is_a_water_sport, null, 100, R.attr.color300, peopleIconID);
        col3Data = new LessonData(NAME_works_for_the_government_He_is_a_politician.KEY, occupations, R.layout.description_name_works_for_the_government_he_is_a_politician, null, 100, R.attr.color300, peopleIconID);
        row.setCol1(col1Data);
        row.setCol2(col2Data);
        row.setCol3(col3Data);
        lessonRows.add(row);
        ...
        col1Data = new LessonData(NAME_writes_songs.KEY, occupations, R.layout.description_name_writes_songs, col1Prerequisites, 100, R.attr.color300, peopleIconID);
        col2Prerequisites = new ArrayList<>(1);
        col2Prerequisites.add(NAME_plays_SPORT_It_is_a_water_sport.KEY);
        col2Data = new LessonData(NAME_plays_SPORT_It_is_a_individual_team_sport.KEY, occupations, R.layout.description_name_plays_sport_it_is_a_individual_sport, col2Prerequisites, 100, R.attr.color300, peopleIconID);
        col3Prerequisites = new ArrayList<>(1);
        col3Prerequisites.add(NAME_works_for_the_government_He_is_a_politician.KEY);
        col3Data = new LessonData(NAME_works_for_EMPLOYER.KEY, occupations, R.layout.description_name_works_for_the_government_he_is_a_politician, col3Prerequisites, 100, R.attr.color300, peopleIconID);
        row.setCol1(col1Data);
        row.setCol2(col2Data);
        row.setCol3(col3Data);
        lessonRows.add(row);
        ...
        col1Data = new LessonData(NAME_creates_art.KEY, occupations, R.layout.description_name_creates_art, col1Prerequisites, 100, R.attr.color300, peopleIconID);
        col2Prerequisites = new ArrayList<>(1);
        ...
        row = new LessonListRow();
        col1Data = new LessonData(Find_stand_sit_on_a_bed.KEY, action, R.layout.description_find_stand_sit_on_a_bed, null, 100, R.attr.color300, actionIconID);
        col2Data = new LessonData(NAME_drives_a_car_to_CITY.KEY, people, R.layout.description_name_drives_a_car_to_city, null, 100, R.attr.color500, peopleIconID);
        col3Data = new LessonData(Turn_left_right_go_straight.KEY, action, R.layout.description_turn_left_right_go_straight, null, 100, R.attr.color300, actionIconID);
        row.setCol1(col1Data);
        row.setCol2(col2Data);
        row.setCol3(col3Data);
        lessonRows.add(row);
        ...
        col2Data = new LessonData(COUNTRY_drives_on_the_left_right.KEY, places, R.layout.description_country_drives_on_the_left_right, col2Prerequisites, 100, R.attr.color300, placesIconID);
        col3Data = new LessonData(NAME_speaks_LANGUAGE.KEY, people, R.layout.description_name_speaks_language, null, 100, R.attr.color500, peopleIconID);
        row.setCol1(col1Data);
        row.setCol2(col2Data);
        row.setCol3(col3Data);
        lessonRows.add(row);
        ...
        row = new LessonListRow();
        col1Data = new LessonData(The_man_reads_a_book_to_a_child.KEY, people, R.layout.the_man_reads_a_book_to_a_child, null, 100, R.attr.color700, peopleIconID);
        ...
        row = new LessonListRow();
        col2Data = new LessonData(Walk_turn_create_PAST.KEY, action, R.layout.description_walk_turn_create_past, null, 100, R.attr.color300, actionIconID);
        row.setCol2(col2Data);
        lessonRows.add(row);
        ...
        col1Data = new LessonData(NAME_drove_from_CITY_to_CITY2.KEY, people, R.layout.description_name_drove_from_city_to_city2, col1Prerequisites, 100, R.attr.color500, peopleIconID);
        col2Prerequisites = new ArrayList<>(1);
        col2Prerequisites.add(Walk_turn_create_PAST.KEY);
        col2Data = new LessonData(NAME_spoke_at_TED_he_spoke_about_SUBJECT.KEY, people, R.layout.description_name_spoke_at_ted_he_spoke_about_subject, col2Prerequisites, 100, R.attr.color500, peopleIconID);
        row.setCol1(col1Data);
        row.setCol2(col2Data);
        lessonRows.add(row);
        ...
        row = new LessonListRow();
        col1Prerequisites = new ArrayList<>(1);
        col1Prerequisites.add(NAME_was_a_OCCUPATION.KEY);
        col1Data = new LessonData(NAME_wrote_a_book_about_SUBJECT.KEY, occupations, R.layout.description_name_wrote_a_book_about_subject, col1Prerequisites, 100, R.attr.color500, peopleIconID);
        col2Prerequisites = new ArrayList<>(1);
        col1Prerequisites.add(NAME_drove_from_CITY_to_CITY2.KEY);
        col2Data = new LessonData(NAME_was_a_OCCUPATION.KEY, occupations, R.layout.description_name_was_a_occupation, col2Prerequisites, 100, R.attr.color700, peopleIconID);
        row.setCol1(col1Data);
        row.setCol2(col2Data);
        lessonRows.add(row);
        ...
        col1Data = new LessonData(NAME_worked_for_the_government_He_was_a_politician.KEY, occupations, null, col1Prerequisites, 100, R.attr.color300, peopleIconID);
        col2Prerequisites = new ArrayList<>(1);
        col2Prerequisites.add(NAME_wrote_a_book_about_SUBJECT.KEY);
        col2Data = new LessonData(NAME_played_SPORT.KEY, occupations, R.layout.description_name_wrote_a_book_about_subject, col2Prerequisites, 100, R.attr.color500, peopleIconID);
        row.setCol1(col1Data);
        row.setCol2(col2Data);
        lessonRows.add(row);
