...
public class LessonHierarchyViewer {
    ...
    private void populateLessons(){
        ...
        col2Data = new LessonData(NAME_is_AGE_years_old_NAME_is_a_GENDER.KEY, people, R.layout.description_name_is_age_years_old_name_is_a_gender, col2Prerequisites, 100, R.color.lblue700, peopleIconID);
        ...
        col1Data = new LessonData(Hi_hey_whats_up.KEY, greetings, R.layout.description_hi_hey_whats_up, col1Prerequisites, 100, R.color.lblue300, greetingsIconID);
        ...
        row = new LessonListRow();
        col1Data = new LessonData(Find_stand_sit_on_a_bed.KEY, action, null, null, 100, R.color.lblue300, actionIconID);
        col2Data = new LessonData(NAME_drives_a_car.KEY, people, null, null, 100, R.color.lblue500, peopleIconID);
        col3Data = new LessonData(Turn_left_right_go_straight.KEY, action, null, null, 100, R.color.lblue300, actionIconID);
        row.setCol1(col1Data);
        row.setCol2(col2Data);
        row.setCol3(col3Data);
        lessonRows.add(row);
        ...
        row = new LessonListRow();
        col1Data = new LessonData(Thanks_no_problem.KEY, greetings, null, null, 100, R.color.lblue500, greetingsIconID);
        col2Prerequisites = new ArrayList<>(3);
        ...
        col2Data = new LessonData(COUNTRY_drives_on_the_left_right.KEY, places, null, col2Prerequisites, 100, R.color.lblue300, placesIconID);
        col3Data = new LessonData(NAME_speaks_LANGUAGE.KEY, people, null, null, 100, R.color.lblue500, peopleIconID);
        row.setCol1(col1Data);
        row.setCol2(col2Data);
        row.setCol3(col3Data);
        lessonRows.add(row);
        ...
        row = new LessonListRow();
        col1Data = new LessonData(The_man_woman_reads_a_book.KEY, people, null, null, 100, R.color.lblue700, peopleIconID);
        col2Data = new LessonData(PLACE_is_a_city_town.KEY, places, null, null, 100, R.color.lblue300, peopleIconID);
        ...
        row = new LessonListRow();
        col1Data = new LessonData(NAME_spoke_at_TED.KEY, people, null, null, 100, R.color.lblue500, peopleIconID);
        col2Data = new LessonData(I_turned_left_right.KEY, action, null, null, 100, R.color.lblue300, actionIconID);
        col3Data = new LessonData(NAME_was_a_OCCUPATION.KEY, occupations, null, null, 100, R.color.lblue700, peopleIconID);
        row.setCol1(col1Data);
        row.setCol2(col2Data);
        row.setCol3(col3Data);
        lessonRows.add(row);
        ...
        col1Data = new LessonData(NAME_drove_from_CITY.KEY, people, null, col1Prerequisites, 100, R.color.lblue500, peopleIconID);
        col2Prerequisites = new ArrayList<>(2);
        col2Prerequisites.add(I_turned_left_right.KEY);
        col2Prerequisites.add(NAME_was_a_OCCUPATION.KEY);
        col2Data = new LessonData(NAME_created_art.KEY, occupations, null, col2Prerequisites, 100, R.color.lblue300, peopleIconID);
        row.setCol1(col1Data);
        row.setCol2(col2Data);
        lessonRows.add(row);
        ...
        col1Data = new LessonData(NAME_wrote_a_book.KEY, occupations, null, col1Prerequisites, 100, R.color.lblue500, peopleIconID);
        row.setCol1(col1Data);
        lessonRows.add(row);
        ...
        col1Data = new LessonData(NAME_played_SPORT.KEY, occupations, null, col1Prerequisites, 100, R.color.lblue500, peopleIconID);
        col2Prerequisites = new ArrayList<>(1);
        col2Prerequisites.add(NAME_wrote_a_book.KEY);
        col2Data = new LessonData(NAME_worked_for_the_government_He_was_a_politician.KEY, occupations, null, col2Prerequisites, 100, R.color.lblue300, peopleIconID);
        row.setCol1(col1Data);
        row.setCol2(col2Data);
        lessonRows.add(row);
        ...
        col2Data = new LessonData("id_review7", review, null, col2Prerequisites, 100, 0, 0);
        row.setCol2(col2Data);
        lessonRows.add(row);
