...
public class OnboardingIntroduction2 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        choicesLayout = view.findViewById(R.id.onboarding_introduction2_choices);
        loading = view.findViewById(R.id.onboarding_introduction2_loading);
        searchview = view.findViewById(R.id.onboarding_introduction2_searchview);
    ...
    private void animate(){
        if (getView() == null)
            return;
        final TextView dialogue = getView().findViewById(R.id.onboarding_introduction2_dialogue);
    ...
    private void animate2(){
        if (getView() == null)
            return;
        final TextView smallDialogue = getView().findViewById(R.id.onboarding_introduction2_dialogue_small);
    ...
    private void animate3(){
        if (getView() == null)
            return;
        TextView instructions = getView().findViewById(R.id.onboarding_introduction2_instructions);
