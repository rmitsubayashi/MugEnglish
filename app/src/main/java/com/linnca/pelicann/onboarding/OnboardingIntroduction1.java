...
public class OnboardingIntroduction1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        whoAreYou = view.findViewById(R.id.onboarding_introduction1_who_are_you);
    ...
    private void animate1(){
        if (getView() == null)
            return;
        final TextView title = getView().findViewById(R.id.onboarding_introduction1_title);
        final ImageView person = getView().findViewById(R.id.onboarding_introduction1_person);
    ...
    private void animate2(){
        if (getView() == null)
            return;
        final TextView introduction = getView().findViewById(R.id.onboarding_introduction1_introduction);
