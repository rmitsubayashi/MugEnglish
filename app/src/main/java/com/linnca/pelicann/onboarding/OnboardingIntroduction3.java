...
public class OnboardingIntroduction3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        greatButton = view.findViewById(R.id.onboarding_introduction3_great);
        ...
        personImage = view.findViewById(R.id.onboarding_introduction3_person);
        explanation = view.findViewById(R.id.onboarding_introduction3_explanation);
        ...
        introduction = view.findViewById(R.id.onboarding_introduction3_introduction);
    ...
    private void animate1(){
        if (getView() == null)
            return;
        final TextView title = getView().findViewById(R.id.onboarding_introduction3_title);
