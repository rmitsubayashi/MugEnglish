...
public class NAME_created_art extends Lesson{
    public static final String KEY = "NAME_created_art";
    ...
    public NAME_created_art(EndpointConnectorReturnsXML connector, Database db, LessonListener listener){
