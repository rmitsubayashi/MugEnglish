...
public class The_man_reads_a_book_to_a_child extends Lesson {
    ...
    private String puzzlePiecesAnswer2(){
        return Question_SentencePuzzle.formatAnswer(puzzlePieces2());
    }
    ...
    private String fillInBlankInputQuestion(){
        ...
        String sentence2 = "The man " + Question_FillInBlank_Input.FILL_IN_BLANK_TEXT + " a book to a child.";
        return sentence1 + "\n\n" + sentence2;
    }

    private String fillInBlankInputQuestion2(){
        String sentence1 = formatSentenceJP2();
        String sentence2 = "The woman " + Question_FillInBlank_Input.FILL_IN_BLANK_TEXT + " a book to a child.";
        return sentence1 + "\n\n" + sentence2;
    }
    ...
    private String fillInBlankMultipleChoiceQuestion1(){
        String sentence1 = formatSentenceJP();
        String sentence2 =  "The " + Question_FillInBlank_MultipleChoice.FILL_IN_BLANK_MULTIPLE_CHOICE +
                " reads a " + Question_FillInBlank_MultipleChoice.FILL_IN_BLANK_MULTIPLE_CHOICE +
                " to a " + Question_FillInBlank_MultipleChoice.FILL_IN_BLANK_MULTIPLE_CHOICE + ".";
        return sentence1 + "\n\n" + sentence2;
    }
