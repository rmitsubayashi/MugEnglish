...
public class LessonsReviewManager {
    ...
    public void nextQuestion(Context context, final boolean isFirstQuestion){
        if (!reviewStarted)
            return;
        ...
        db.getQuestion(context, questionIDs.get(questionMkr), onDBResultListener);
    }
