...
public class QuestionManager{
	...
	public void startQuestions(NetworkConnectionChecker networkConnectionChecker, LessonInstanceData data, String lessonKey, OnDBResultListener noConnectionListener){
		if(!questionsStarted) {
			...
			nextQuestion(networkConnectionChecker, true, noConnectionListener);
		}
	}
	...
	public void nextQuestion(NetworkConnectionChecker networkConnectionChecker, final boolean isFirstQuestion, final OnDBResultListener noConnectionListener){
		...
		db.getQuestion(networkConnectionChecker, questionID, onDBResultListener);
	}
