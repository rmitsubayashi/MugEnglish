...
public class NAME_is_DEMONYM extends Lesson {
    ...
    private String fillInBlankQuestion(QueryResult qr){
        ...
        String sentence2 = qr.personEN + " is " + QuestionUniqueMarkers.FILL_IN_BLANK_MULTIPLE_CHOICE + ".";
        return sentence1 + "\n" + sentence2;
    }
    ...
    private String fillInBlank2Question(QueryResult qr){
        ...
        String sentence2 = qr.personEN + " is " + QuestionUniqueMarkers.FILL_IN_BLANK_INPUT_TEXT + ".";
        return sentence1 + "\n\n" + sentence2;
    }
