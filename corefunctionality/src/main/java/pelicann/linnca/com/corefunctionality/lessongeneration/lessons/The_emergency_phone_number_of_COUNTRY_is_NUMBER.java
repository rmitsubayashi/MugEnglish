...
public class The_emergency_phone_number_of_COUNTRY_is_NUMBER extends Lesson {
    ...
    private String fillInBlankInput1Question(QueryResult qr){
        ...
        String sentence2 = "The emergency phone number of " + qr.countryEN + " is " + QuestionUniqueMarkers.FILL_IN_BLANK_INPUT_TEXT + ".";
    ...
    private String fillInBlankInputQuestion2(QueryResult qr){
        ...
        String sentence2 = qr.countryJP + "の緊急通報用電話番号は" + QuestionUniqueMarkers.FILL_IN_BLANK_INPUT_NUMBER +
                "です。";
        return sentence1 + "\n\n" + sentence2;
